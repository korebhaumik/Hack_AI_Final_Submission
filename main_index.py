...
import json
import datetime
from agent import redis
from agent import get_temperature
import time
from main_agent_redis import redis
...
@app_commands.describe(
    prompt="Set the mininum temperature threshold for the alert.",
)
